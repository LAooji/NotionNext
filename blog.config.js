...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '大拙至美 静水流深',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大拙设计', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '大拙空间设计有限公司', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zhuo.design', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '设计,装修,装修设计,室内设计,大拙, 别墅, 适老化, 养老, 办公, 餐饮, 办公室装修,适老化改造,办公室装修,办公室设计,餐饮设计,适老化设计,别墅设计,家装,家装设计', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zhuo@zhuo.design', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 鄂ICP备2020018270号', // 备案号 闽ICP备XXXXXXX
